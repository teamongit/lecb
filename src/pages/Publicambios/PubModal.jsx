...
export function ModalDetalle({ pub, usuario, onClose, onApuntarme, onBorrarme, apuntando }) {
  ...
  const mensaje = `Hola ${pub.apodo}, vi tu publicación sobre "${pub.tipo + ": " + getTextoTurno()}" el ${formatearFecha(pub.fecha,{ weekday: "short", day: "numeric", month: "long" })} y me interesa el cambio.`;
  ...
  return (
    <Modal show={true} onHide={onClose} centered size="lg">
      ...
      <Modal.Footer>        
        {pub.telefono &&
          <WhatsappButton telefono={pub.telefono} mensaje={mensaje} textoButton="Contactar"/>
        }
        {!esPropia && (
          yaApuntado ? (
